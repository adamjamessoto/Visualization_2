...
function setup() {
  ...
  // ********** an array with some too lazy to replace stockprices which are actually schools **********
  var stockPrices = [.758, .862, .901, .848, .841, .871, .709, .867, .928, .891];
  var stockNames = ["Harvard", "Stanford", "UChicago", "Wharton", "MIT", "NorthWestern", "UC Berkeley",  "Dartmouth", "Yale", "Columbia" ];
  ...
  //for (var i = 0; i < stocks.query.results.quote.length; i++) {
    ...
    //set the color of the hachure to Harvard Crimson
    stroke( 153, 0, 0 );
